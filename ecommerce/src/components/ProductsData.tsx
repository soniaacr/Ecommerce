      ...
      <div>
        <Link href={{ pathname: "/product", query: { _id: item?._id } }}>
          <div className="w-full h-96 group overflow-hidden relative">
            ...
            />
            {item?.isNew && (
              <span className="absolute top-2 right-2 font-medium text-xs py-1 px-3 bg-white group-hover:bg-pink-400 group-hover:text-white duration-200">
                New Arrival
              </span>
            )}
          </div>
        ...
        <div className="border-[1px] border-slate-300 border-t-0 px-2 py-4 flex flex-col gap-y-2 bg-white rounded-b-lg">
          ...
          <div className="flex items-center justify-between">
            <div className="border-[1px] border-pink-300 py-1 px-4 rounded-full text-xs">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="bg-pink-300 px-4 py-2 text-sm tracking-wide text-slate-100 hover:bg-pink-400 hover:text-white duration-200"
            >
              add to cart
            </button>
            {/* star icons */}
